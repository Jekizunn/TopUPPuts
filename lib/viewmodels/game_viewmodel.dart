...
class GameViewModel {
  final List<Game> _dummyGames = [
    Game(
        ...
        genre: "Battle Royale",
        thumbnailUrl: "https://upload.wikimedia.org/wikipedia/en/6/65/COD_Warzone_Cover_Art.jpg", // Ganti URL
        bannerUrl: "https://upload.wikimedia.org/wikipedia/en/6/65/COD_Warzone_Cover_Art.jpg", // Ganti URL
        category: "PC",
    ...
    Game(
        ...
        title: "Apex Legends",
        genre: "Battle Royale",
        thumbnailUrl: "https://via.placeholder.com/150/FF0000/FFFFFF?Text=Apex", // Ganti URL
    ...
    Game(
        ...
        thumbnailUrl: "https://via.placeholder.com/150/FF4500/FFFFFF?Text=Valorant", // Ganti URL
    ...
    Game(
        ...
        genre: "MOBA",
        thumbnailUrl: "https://via.placeholder.com/150/FFA500/000000?Text=LoLWR", // Ganti URL
